          ...
          <>
            ...
            <h2 className="title">Registro de nuevos usuarios:</h2>
              <div className="fields">
                ...
                <Field type="mail" name="email" id="email" placeholder="ejemplo_123@mail.com" />
              </div>
              <div className="fields">
                <label htmlFor="payment_days" className="subtitles">Fecha de pago:</label>
                <Field type="date" name="payment_days" id="payment_days"/>
              </div>
              <div className="fields">
                ...
                />
                <Field type="date" name="next_payment" id="next_payment" />
              </div>
              <div className="fields">
                ...
                />
                <Field type="text" name="name" id="name" placeholder="nombre(s)" />
                <label htmlFor="lastname" className="subtitles">Apellido:</label>
                <ErrorMessage name="lastname"
                  component={() => (
                    <div className="error">{errors.lastname}</div>)} />
                <Field type="text" name="lastname" id="lastname" placeholder="apellido(s)" />
              </div>
              <div className="fields">
                ...
                />
                <Field type="tel" name="phone" id="phone" placeholder="teléfono móvil o local" />
                ...
                <Field type="tel" name="phone_contact" id="phone_contact" placeholder="contacto móvil o local" />
              </div>
              <div className="fields">
              ...
              <div className="fields">
                ...
                />
                <Field type="number" name="age" id="age" placeholder="edad" min={1}  max={99} />
                <label htmlFor="heigth" className="subtitles">Estatura:</label>
                <ErrorMessage name="heigth"
                  component={() => (
                    <div className="error">{errors.heigth}</div> )}
                />
                <Field type="number" name="heigth" id="height" placeholder="metros" step={0.01} precision={0.02} min={0.5} max={2.5} />
                <label htmlFor="weigth" className="subtitles">Peso:</label>
                <ErrorMessage name="weigth"
                  component={() => (
                    <div className="error">{errors.weigth}</div> )}
                />
                <Field type="number" name="weigth" id="weigth" placeholder="kilogramos" step={0.01} precision={2} min={10} max={180} />
              </div>
              <div className="fields">
                <label htmlFor="neck" className="subtitles">Cuello:</label>
                <Field type="number" name="neck" placeholder="centimetros" id="neck" step={0.1} precision={2} min={10} max={70} />
                <label htmlFor="waist" className="subtitles">Cintura:</label>
                <Field type="number" name="waist" id="waist" placeholder="centimetros" step={0.1} precision={2} min={20} max={200} />             
                {/* Solo para el caso de values.gender == "femenino" */}
                <div>
                  {(values.gender === "femenino" && <>
                    <label htmlFor="hip" className="subtitles">Cadera:</label>
                    <Field type="number" name="hip" id="hip" placeholder="centimetros" step={0.1} precision={2} min={20} max={200} /></>)}          
                </div>
              </div>
              <div className="fields">
              ...
              <div className="fields">
                ...
                <div>{
                  ...
                  <><label htmlFor="frequency" className="subtitles">
                    ...
                    </label><Field type="range" name="frequency" id="frequency" min={0} max={7} step={1} /></>)}
                </div>
              </div>
              <div><center>
